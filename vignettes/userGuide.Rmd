...
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_boxplot_logcpm_before_filtering.png")
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_boxplot_logcpm_after_filtering.png")
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_barplot_logcpm_before_filtering.png")
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_barplot_logcpm_after_filtering.png")
```

```{r filters1b, echo=FALSE, out.width='43%', fig.cap="Density Graphes", out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_densityGraph_RawData.png")
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_densityGraph_FilteredData.png")
```
...
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_boxplot_logcpm_after_norm.png")
```
...
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_heatmap_CPMcounts_per_sample.png")
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_heatmap_CPMmean_per_condition.png")
```
...
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_MDS_corr_axe1_2.png")
knitr::include_graphics("../inst/extdata/DEG_test/DataExplore/DEG_test_PCA_axe1_2.png")
```
...
You'll find in **"DEG_test/DEanalysis/DEimages"** directory, les Volcano, MD plots and heatmap for each contrast.<br/><br/>

```{r dge, fig.cap="DEanalysis plots", echo=FALSE, out.width='43%', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/DEanalysis/DEimages/AC3vsBC3_MeanDifference_of_ExpressionData.png")
knitr::include_graphics("../inst/extdata/DEG_test/DEanalysis/DEimages/AC3vsBC3_VolcanoPlot.png")
```
...
knitr::include_graphics("../inst/extdata/DEG_test/DEanalysis/DEimages/AC3vsBC3_topDGE_heatmap.png")
```
...
knitr::include_graphics("../inst/extdata/DEG_test/VennDiagrams/AC1vsBC1-AC2vsBC2-AC3vsBC3_all.png")
knitr::include_graphics("../inst/extdata/DEG_test/VennDiagrams/AC1vsBC1-AC2vsBC2-AC3vsBC3_up.png")
knitr::include_graphics("../inst/extdata/DEG_test/VennDiagrams/AC1vsBC1-AC2vsBC2-AC3vsBC3_down.png")
knitr::include_graphics("../inst/extdata/DEG_test/VennDiagrams/AC1vsBC1-AC2vsBC2_mixed.png")
```
...
knitr::include_graphics("../inst/extdata/DEG_test/UpsetGraphs/Subset_upset/AC1vsBC1-AC2vsBC2-AC3vsBC3_allDEG.png")
knitr::include_graphics("../inst/extdata/DEG_test/UpsetGraphs/Subset_upset/AC1vsBC1-AC2vsBC2-AC3vsBC3_upDEG.png")
knitr::include_graphics("../inst/extdata/DEG_test/UpsetGraphs/Subset_upset/AC1vsBC1-AC2vsBC2-AC3vsBC3_downDEG.png")
knitr::include_graphics("../inst/extdata/DEG_test/UpsetGraphs/Subset_upset/AC1vsBC1-AC2vsBC2-AC3vsBC3_mixedDEG.png")
```
...
By changing **parameters$GO** to "up" or "down", you can exevute GO-term enrichment on UP-regulated genes or DOWN-regulated genes separately.

```{r GOgraph, fig.cap="GO Enrichment graphs", echo=FALSE, out.width='43%',  out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/GOenrichment/TOTAL_DEgenes/AC1vsBC1_Pvalue_BUBBLESgraph.png")
knitr::include_graphics("../inst/extdata/DEG_test/GOenrichment/TOTAL_DEgenes/AC1vsBC1_Ratio_BUBBLESgraph.png")
```
...
```{r plot1clust, fig.cap="Boxplot", echo=FALSE, out.width='50%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/Clustering/OnDEgenes/kmeans_clr_4clusters/DEG_test_Boxplots_ScaledCPM_kmeans_clr.png")
```
...
```{r plot2clust, fig.cap="Heatmap", echo=FALSE, out.width='50%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/Clustering/OnDEgenes/kmeans_clr_4clusters/DEG_test_Heatmap_ScaledCPM_kmeans_clr.png")
```
...
```{r plot3clust, fig.cap="Probabilities", echo=FALSE, out.width='50%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/Clustering/OnDEgenes/kmeans_clr_4clusters/DEG_test_ClusterProbabilities_kmeans_clr_Threshold0.8.png")
```
...
```{r plot3bisclust, fig.cap="Probabilities", echo=FALSE, out.width='70%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/Clustering/OnDEgenes/kmeans_clr_4clusters/Cluster_3/DEG_test_ScaledExpression_kmeans_clr_Cluster_3.png")
```
...
```{r plot4clust, fig.cap="Probabilities", echo=FALSE, out.width='70%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/Clustering/OnDEgenes/kmeans_clr_4clusters/Cluster_3/DEG_test_UpSet_kmeans_clr_Cluster_3.png")
```
...
```{r plot5clust, fig.cap="GO-enrichment", echo=FALSE, out.width='40%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/Clustering/OnDEgenes/kmeans_clr_4clusters/Cluster_3/DEG_test_GOEnrichment_kmeans_clr_Cluster_3_BP.png")
knitr::include_graphics("../inst/extdata/DEG_test/Clustering/OnDEgenes/kmeans_clr_4clusters/Cluster_3/DEG_test_GOEnrichment_kmeans_clr_Cluster_3_CC.png")
knitr::include_graphics("../inst/extdata/DEG_test/Clustering/OnDEgenes/kmeans_clr_4clusters/Cluster_3/DEG_test_GOEnrichment_kmeans_clr_Cluster_3_MF.png")
...
```{r enrichcontrast, fig.cap="Gene enrichment in contrasts", echo=FALSE, out.width='70%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/Clustering/OnDEgenes/kmeans_clr_4clusters/Cluster_3/DEG_test_GenesInContrasts_kmeans_clr_Cluster_3.png")
```
...
```{r nonDE, fig.cap="Clustering with non DE genes", echo=FALSE, out.width='70%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/Clustering/OnDEgenes/kmeans_clr_4clusters/DEG_test_Boxplots_ScaledCPM_WithNonDEgenes_kmeans_clr.png")
```
...
If you want, you can also perform GO-enrichment on a specific list of genes (list of interest from another study, list of genes hightly expressed, ...). In this case, you can use the GOenrichment function with two supplementary parameters: the list of the names of the genes you want to analyze and the name you want to set for this list. This function produces the same outputs than the GOenrichment function used on contrasts in 'GO Enrichment Analysis' part.The directory used for the outputs is **"DEG_test/GOenrichment/OnSpecificList_NameOfTheList/"**. Here is an example on the 1000 first genes of the list:
...
```{r GOgraph2, fig.cap="Gene information", echo=FALSE, out.width='70%',  out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/GeneListExplore/First25genes/First25genes_Complete_heatmap.png")
```
...
```{r geneinfo2, eval=FALSE}
list=rownames(resDEG[1:25,])
GeneInfo_OnList(list, resDEG, data, parameters, "First25genes_WithClust", clust)
```

```{r GOgraph3, fig.cap="Gene information with clustering", echo=FALSE, out.width='70%',  out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/GeneListExplore/First25genes_WithClust/First25genes_WithClust_Complete_heatmap.png")
```
...
```{r GOgraph4, fig.cap="Subset gene information with clustering", echo=FALSE, out.width='70%',  out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/GeneListExplore/First25genes_WithClust/First25genes_WithClust_Subset_heatmap.png")
```

##############################################
# ATTENTION : enlever le source au chargement du package !!!!!!#
##############################################
