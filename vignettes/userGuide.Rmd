...
```{r dEgraph, fig.cap="DE numbers barplots", echo=FALSE, out.width='80%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/DEanalysis/DEimages/DEGsnumber_InContrasts.png")
```
...
```{r dge3, fig.cap="Pvalue graphs", echo=FALSE, out.width='80%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/DEG_test/DEanalysis/DEimages/AC3vsBC3_Pval_Plot.png")
```
