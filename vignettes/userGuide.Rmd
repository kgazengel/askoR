...
knitr::include_graphics("../inst/extdata/WikiImgs/Boxplot_logcpm_before_filtering.png")
knitr::include_graphics("../inst/extdata/WikiImgs/Boxplot_logcpm_after_filtering.png")
knitr::include_graphics("../inst/extdata/WikiImgs/Barplot_SumCounts_before_filtering.png")
knitr::include_graphics("../inst/extdata/WikiImgs/Barplot_SumCounts_after_filtering.png")
```

```{r filters1b, echo=FALSE, out.width='43%', fig.cap="Density Graphes", out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/WikiImgs/DensityGraph_RawData_1.png")
knitr::include_graphics("../inst/extdata/WikiImgs/DensityGraph_FilteredData_1.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/DensityGraph_RawData.png")
knitr::include_graphics("../inst/extdata/WikiImgs/DensityGraph_FilteredData.png")
```
...
```{r norm, fig.cap="Normalization graphs ", echo=FALSE, out.width='43%', fig.align='center', out.extra='style="display:inline-block;margin:0;padding:0;"'}
knitr::include_graphics("../inst/extdata/WikiImgs/Boxplot_logcpm_after_norm.png")
knitr::include_graphics("../inst/extdata/WikiImgs/Barplot_SumCounts_after_norm.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/Heatmap_CPMcounts_per_sample.png")
knitr::include_graphics("../inst/extdata/WikiImgs/Heatmap_CPMmean_per_condition.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/MDS_corr_axe1_2.png")
knitr::include_graphics("../inst/extdata/WikiImgs/PCA_axe1_2.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/DEGsnumber_InContrasts.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/MeanDifference_of_ExpressionData.png")
knitr::include_graphics("../inst/extdata/WikiImgs/VolcanoPlot.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/TopDGE_heatmap.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/AC3vsBC3_Pval_Plot.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/AC1vsBC1-AC2vsBC2-AC3vsBC3_all.png")
knitr::include_graphics("../inst/extdata/WikiImgs/AC1vsBC1-AC2vsBC2-AC3vsBC3_up.png")
knitr::include_graphics("../inst/extdata/WikiImgs/AC1vsBC1-AC2vsBC2-AC3vsBC3_down.png")
knitr::include_graphics("../inst/extdata/WikiImgs/AC1vsBC1-AC2vsBC2_mixed.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/AC1vsBC1-AC2vsBC2-AC3vsBC3_allDEG.png")
knitr::include_graphics("../inst/extdata/WikiImgs/AC1vsBC1-AC2vsBC2-AC3vsBC3_upDEG.png")
knitr::include_graphics("../inst/extdata/WikiImgs/AC1vsBC1-AC2vsBC2-AC3vsBC3_downDEG.png")
knitr::include_graphics("../inst/extdata/WikiImgs/AC1vsBC1-AC2vsBC2-AC3vsBC3_mixedDEG.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/AC1vsBC1_Pvalue_BUBBLESgraph.png")
knitr::include_graphics("../inst/extdata/WikiImgs/AC1vsBC1_Ratio_BUBBLESgraph.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/Boxplots_ScaledCPM_kmeans_clr.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/Heatmap_ScaledCPM_kmeans_clr.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/ClusterProbabilities_kmeans_clr_Threshold0.8.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/ScaledExpression_kmeans_clr_Cluster_3.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/UpSet_kmeans_clr_Cluster_3.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/GOEnrichment_kmeans_clr_Cluster_3_BP.png")
knitr::include_graphics("../inst/extdata/WikiImgs/GOEnrichment_kmeans_clr_Cluster_3_CC.png")
knitr::include_graphics("../inst/extdata/WikiImgs/GOEnrichment_kmeans_clr_Cluster_3_MF.png")
...
knitr::include_graphics("../inst/extdata/WikiImgs/GenesInContrasts_kmeans_clr_Cluster_3.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/Boxplots_ScaledCPM_WithNonDEgenes_kmeans_clr.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/First25genes_Complete_heatmap.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/First25genes_WithClust_Complete_heatmap.png")
```
...
knitr::include_graphics("../inst/extdata/WikiImgs/First25genes_WithClust_Subset_heatmap.png")
```
